...
class QRScannerLunch extends StatefulWidget {
  const QRScannerLunch({super.key});

  @override
  State<StatefulWidget> createState() => _QRScannerLunchState();
}

class _QRScannerLunchState extends State<QRScannerLunch> {
  ...
  Future<void> _checkAndUpdateUser(String uniqueId) async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      if (doc['lunch'] != true) {
        await doc.reference.update({'lunch': true});
        _showDialog('Verified', Icons.check_circle_outline, Colors.green);
      } else {
        _showDialog('Repeating lunch - don\'t allow', Icons.cancel, Colors.red);
      }
    } else {
