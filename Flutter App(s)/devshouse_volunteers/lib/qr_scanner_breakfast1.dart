...
class QRScannerBreakfast1 extends StatefulWidget {
  const QRScannerBreakfast1({super.key});

  @override
  State<StatefulWidget> createState() => _QRScannerBreakfast1State();
}

class _QRScannerBreakfast1State extends State<QRScannerBreakfast1> {
  ...
  Future<void> _checkAndUpdateUser(String uniqueId) async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      if (doc['breakfast_1'] != true) {
        await doc.reference.update({'breakfast_1': true});
