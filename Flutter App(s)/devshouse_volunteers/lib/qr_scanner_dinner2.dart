...
class QRScannerDinner2 extends StatefulWidget {
  const QRScannerDinner2({super.key});

  @override
  State<StatefulWidget> createState() => _QRScannerDinner2State();
}

class _QRScannerDinner2State extends State<QRScannerDinner2> {
  ...
  Future<void> _checkAndUpdateUser(String uniqueId) async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      if (doc['dinner_2'] != true) {
        await doc.reference.update({'dinner_2': true});
