...
class QRScannerSnacks3 extends StatefulWidget {
  const QRScannerSnacks3({super.key});

  @override
  State<StatefulWidget> createState() => _QRScannerSnacks3State();
}

class _QRScannerSnacks3State extends State<QRScannerSnacks3> {
  ...
  Future<void> _checkAndUpdateUser(String uniqueId) async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      if (doc['snacks_3'] != true) {
        await doc.reference.update({'snacks_3': true});
