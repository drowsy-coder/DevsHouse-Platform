...
class QRScannerSnacks2 extends StatefulWidget {
  const QRScannerSnacks2({super.key});

  @override
  State<StatefulWidget> createState() => _QRScannerSnacks2State();
}

class _QRScannerSnacks2State extends State<QRScannerSnacks2> {
  ...
  Future<void> _checkAndUpdateUser(String uniqueId) async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      if (doc['snacks_2'] != true) {
        await doc.reference.update({'snacks_2': true});
